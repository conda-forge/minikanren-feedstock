...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/minikanren-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14305&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/minikanren-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `minikanren` can be installed with:

```
conda install minikanren
```

It is possible to list all of the versions of `minikanren` available on your platform with:
